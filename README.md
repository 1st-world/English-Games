...
여기에 제공하는 서드 파티 라이선스 정보는 편의를 위한 요약에 불과하며, 정확하고 법적 효력을 가지는 조건은 각 원본 라이선스 문서 및 공식 출처 등을 직접 확인하기 바랍니다.
...
- 일부 아이콘 도입을 위한 서드 파티 에셋을 프로젝트 내에 포함하고 있습니다.
  ...
  - 문서에 따르면, 아이콘은 CC BY 4.0, 웹 글꼴은 SIL OFL 1.1, 코드는 MIT License에 해당합니다.
